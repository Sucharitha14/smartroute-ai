    ...
    <>
      ...
      <div className="page" style={{ maxWidth: "780px" }}>
        ...
        <div style={{ marginBottom: "32px" }}>
          <p className="heading-sm" style={{ marginBottom: "8px" }}>Your account</p>
          <h1 className="heading-xl" style={{ marginBottom: "6px" }}>Trip history</h1>
        ...
        {trips.length === 0 ? (
          ...
          <div className="panel">
            ...
            <div style={{
              ...
              {["Route", "Budget", "Style", "Date", ""].map((h, i) => (
                <div key={i} style={{
                  fontSize: "0.75rem",
                  fontWeight: "600",
                  color: "var(--muted)",
            ...
            {trips.map((trip) => (
              ...
              >
                ...
                <div style={{ fontSize: "0.85rem", color: "var(--muted)" }}>
                  {trip.mood.charAt(0).toUpperCase() + trip.mood.slice(1)}
                </div>
            ...
            <div style={{
              ...
              fontSize: "0.78rem",
              color: "var(--muted)",
              borderTop: trips.length > 0 ? "none" : undefined,
            }}>
              Showing {trips.length} {trips.length === 1 ? "record" : "records"}
            </div>
          </div>
        )}
